...
def get_train_parser():
    ...
    parser.add_argument(
        "--dryrun", default=False, type=lambda x: (str(x).lower() == "true")
    )
    parser.add_argument("--gpus", type=int, default=0, help="Number of available GPUs.")
    parser.add_argument(
        "--num_workers", type=int, default=2, help="Number of available CPUs."
    )
    return parser
...
def get_test_parser():
    ...
    parser.add_argument(
        "--timestamp", type=str, required=True, help="timestamp to be processed"
    )
    parser.add_argument(
        "-tn", "--threshold_number", type=int, default=100, help="threshold number"
    )
    parser.add_argument(
...
def get_classic_baseline_parser():
    ...
    )  # currently availible in ruptures
    parser.add_argument(
        "--core_model",
        type=str,
        default="l2",
